...
space0.photo.attach(io: file, filename: 'plage.png', content_type: 'image/png')
...
space2.photo.attach(io: file, filename: 'thuret.png', content_type: 'image/png')
...
p space3.photo.attach(io: file, filename: 'eze.png', content_type: 'image/png')
...
p space4.photo.attach(io: file, filename: 'maravillosa.png', content_type: 'image/png')
...
space5.photo.attach(io: file, filename: 'land.png', content_type: 'image/png')
...
space6.photo.attach(io: file, filename: 'prool.png', content_type: 'image/png')
